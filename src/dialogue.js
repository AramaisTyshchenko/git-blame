...
const ACTS = [
  {
    ...
    description:
      'П\'ятирічний ювілей команди «Aramais» перервано анонімним повідомленням. ' +
...
const CREDITS_DATA = {
  title: 'GIT BLAME',
  subtitle: '5-річчя команди «Aramais» · 2026',
  sections: [
    {
      title: 'КОМАНДА',
      items: [
        ...
        { name: 'Іван',    role: 'QA, все КРИТИЧНО' },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Midjourney / DALL-E',   role: 'Портрети персонажів' },
        { name: 'Suno AI',               role: 'Музичний супровід' },
        { name: 'Stable Diffusion',      role: 'Фонові сцени' },
      ],
    },
    {
      title: 'ТЕХНОЛОГІЇ',
  ...
  aiNote:
    ...
    'зображення згенеровано Midjourney/DALL-E, музика — Suno. ' +
    'Жоден QA-фахівець не постраждав у процесі розробки. ' +
    'Хоча Іван мав кілька КРИТИЧНИХ коментарів.',
};
